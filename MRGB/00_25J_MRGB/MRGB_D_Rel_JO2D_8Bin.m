...
HORJO2D_Lleg8 = [HORJO2D_LA8+HORJO2D_LK8];
HORJO2D_Rarm8 = [HORJO2D_RW8+HORJO2D_RE8];
HORJO2D_Rleg8 = [HORJO2D_RA8+HORJO2D_RK8];

%% Export all Histogram data (HOJO2D) for remaining pipeline
save(['25J_MRGB_Rel_JO_' num2str(numBin) 'bins' '.mat'], 'Rel_JO_Parts8', 'HORJO2D_Larm8', 'HORJO2D_Lleg8', 'HORJO2D_Rarm8', 'HORJO2D_Rleg8');
