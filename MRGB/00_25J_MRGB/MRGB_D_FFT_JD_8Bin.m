...
save(['25J_MRGB_FFT_JD_' num2str(numBin) 'bins' '.mat'], 'FFTJD_RightElbow8', 'FFTJD_RightWrist8', 'FFTJD_RightKnee8', 'FFTJD_RightAnkle8', 'FFTJD_LeftElbow8', 'FFTJD_LeftWrist8', 'FFTJD_LeftKnee8', 'FFTJD_LeftAnkle8');