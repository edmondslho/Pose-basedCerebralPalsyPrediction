...
% AngDisp_FullBody8 = {};
% AngDisp_FullBody8  = reshape(cell2mat(H_jFullBody8), (numBin), (numel(vidRange)))';


%% Export all Histogram data (HOJD2D) for remaining pipeline
save(['25J_MRGB_AngDisp_' num2str(numBin) 'bins' '.mat'], 'AngDisp_RightElbow8', 'AngDisp_RightWrist8', 'AngDisp_RightKnee8', 'AngDisp_RightAnkle8', 'AngDisp_LeftElbow8', 'AngDisp_LeftWrist8', 'AngDisp_LeftKnee8', 'AngDisp_LeftAnkle8');
