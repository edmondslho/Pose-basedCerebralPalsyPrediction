clear;
close all;
load('B_25J_RVI_38_correctedPoseData.mat');

vidRange = 1:38;
jointRange = 1:21; 


%% Calculating the rotation to align imported spine alignment with Y

for vid=vidRange
    allTheta{vid} = {};
    
    frmLength = length(correctedPose{vid}(1,:))-1;
...
save('C_25J_RVI_38_ProcessedData.mat', 'allFinalPose', 'pID');
