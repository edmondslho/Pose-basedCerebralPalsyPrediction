...
save(['25J_RVI_38_FFT_JO_' num2str(numBin) 'bins' '.mat'], 'FFTJO_RightElbow8', 'FFTJO_RightWrist8', 'FFTJO_RightKnee8', 'FFTJO_RightAnkle8', 'FFTJO_LeftElbow8', 'FFTJO_LeftWrist8', 'FFTJO_LeftKnee8', 'FFTJO_LeftAnkle8');