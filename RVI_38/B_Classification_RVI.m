...
%% Importing Normalised and Rotated - Full RVI videos - 25 Joint dataset

load('00_25J_RVI_38_Full/RVI_38_labels.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_HOJO2D_8bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_HOJO2D_16bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_HOJD2D_8bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_HOJD2D_16bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_FFT_JD_8bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_FFT_JD_16bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_FFT_JO_8bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_FFT_JO_16bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_AngDisp_8bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_AngDisp_16bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_Rel_JO_8bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_Rel_JO_16bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_Rel_JO_AngDis_8bins.mat');
load('00_25J_RVI_38_Full/25J_RVI_38_Rel_JO_AngDis_16bins.mat');
...
TNSRE_PoseFusion = {[G16_Ind A8_Ind H8_Ind C16_Ind]};
...
TNSRE_VelFusion = {};
TNSRE_VelFusion_Lbl = {};
TNSRE_VelFusion =  {[B16_Ind D8_Ind I8_Ind]};
